# Generated by Django 2.1.7 on 2019-07-17 21:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banco_agencia', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_nascimento', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
                ...
                ('numero_documento_CPF', models.CharField(max_length=14, validators=[Funcionario.utilities.validateCPF])),
                ...
                ('valor_hora_custo', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True)),
                ('valor_hora_receita', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True)),
                ...
                ('obs_status', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            name='AddressInfo',
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='address_info', serialize=False, to='Funcionario.BasicInfo')),
                ...
                ('end_CEP', models.CharField(blank=True, max_length=9, null=True, validators=[Funcionario.utilities.validateCEP])),
        ...
        migrations.CreateModel(
            name='AnotherJobInfo',
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='another_job', serialize=False, to='Funcionario.BasicInfo')),
                ...
                ('vinc_outra_emp_CNPJ', models.CharField(blank=True, max_length=18, null=True, validators=[Funcionario.utilities.validateCNPJ])),
                ('vinc_outra_emp_salario', models.CharField(blank=True, max_length=10, null=True)),
                ('vinc_outra_emp_nome_soc', models.CharField(blank=True, max_length=300, null=True)),
                ('vinc_outra_emp_CNPJ_soc', models.CharField(blank=True, max_length=18, null=True, validators=[Funcionario.utilities.validateCNPJ])),
                ('vinc_outra_emp_salario_soc', models.CharField(blank=True, max_length=10, null=True)),
                ('vinc_comentarios', models.TextField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ContactInfo',
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='contact_info', serialize=False, to='Funcionario.BasicInfo')),
                ...
                ('cont_email_secundario', models.EmailField(blank=True, max_length=254, null=True)),
                ('cont_email_principal', models.EmailField(blank=True, max_length=254, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ContractualInfo',
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='contractual_info', serialize=False, to='Funcionario.BasicInfo')),
                ('contrat_data_admissao', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
                ('contrat_data_inicio', models.DateField(blank=True, null=True)),
                ('contrat_cargo_inicial', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('contrat_funcao_cargo', models.CharField(blank=True, max_length=100, null=True)),
                ('contrat_funcao_nivel', models.CharField(blank=True, max_length=100, null=True)),
                ('contrat_funcao_nivel_inicial', models.CharField(blank=True, max_length=100, null=True)),
                ('contrat_funcao_gestor', models.BooleanField(blank=True, null=True)),
                ('contrat_funcao_CBO', models.CharField(blank=True, max_length=50, null=True)),
                ('contrat_funcao_descricao', models.TextField(blank=True, null=True)),
                ('contrat_data_ultima_alteracao_cargo', models.DateField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='DocumentAttachments',
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='docscans', serialize=False, to='Funcionario.BasicInfo')),
        ...
        migrations.CreateModel(
            name='DocumentsInfo',
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='documents_info', serialize=False, to='Funcionario.BasicInfo')),
                ...
                ('docs_CTPS_data_emissao', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
                ...
                ('docs_RG_data_emissao', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
                ...
                ('docs_RNE_data_emissao', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
                ...
                ('docs_OC_data_emissao', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
                ...
                ('docs_CNH_data_emissao', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
                ('docs_CNH_categoria', models.CharField(blank=True, choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=1, null=True)),
                ('docs_CNH_data_primeira', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
        ...
        migrations.CreateModel(
            name='ForeignerInfo',
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='foreigner_info', serialize=False, to='Funcionario.BasicInfo')),
                ('estr_data_chegada', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
                ('estr_naturalizado', models.BooleanField(blank=True, null=True)),
                ('estr_data_naturalizacao', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='handicapped_info', serialize=False, to='Funcionario.BasicInfo')),
                ('deficiencia_tipo', models.CharField(blank=True, choices=[('Motora', 'Motora'), ('Visual', 'Visual'), ('Física', 'Física'), ('Auditiva', 'Auditiva'), ('Mental', 'Mental'), ('Intelectual', 'Intelectual'), ('Reabilitado', 'Reabilitado')], max_length=200, null=True)),
                ('deficiencia_obs', models.TextField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='InternInfo',
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='intern_info', serialize=False, to='Funcionario.BasicInfo')),
                ('estag_data_inicio', models.DateField(blank=True, null=True, validators=[Funcionario.utilities.validateNoFutureDates])),
                ...
                ('estag_valor_bolsa', models.CharField(blank=True, max_length=10, null=True)),
                ('estag_instituto_nome', models.CharField(blank=True, max_length=200, null=True)),
                ('estag_instituto_CNPJ', models.CharField(blank=True, max_length=18, null=True)),
                ('estag_instituto_end', models.CharField(blank=True, max_length=200, null=True)),
                ('estag_instituto_end_numero', models.IntegerField(blank=True, null=True)),
                ('estag_instituto_end_municipio', models.CharField(blank=True, max_length=200, null=True)),
                ('estag_instituto_UF', models.CharField(blank=True, choices=[('AC', 'AC'), ('AL', 'AL'), ('AP', 'AP'), ('AM', 'AM'), ('BA', 'BA'), ('CE', 'CE'), ('DF', 'DF'), ('ES', 'ES'), ('GO', 'GO'), ('MA', 'MA'), ('MT', 'MT'), ('MS', 'MS'), ('MG', 'MG'), ('PA', 'PA'), ('PB', 'PB'), ('PR', 'PR'), ('PE', 'PE'), ('PI', 'PI'), ('RJ', 'RJ'), ('RN', 'RN'), ('RS', 'RS'), ('RO', 'RO'), ('RR', 'RR'), ('SC', 'SC'), ('SP', 'SP'), ('SE', 'SE'), ('TO', 'TO')], max_length=2, null=True)),
                ('estag_instituto_CEP', models.CharField(blank=True, max_length=9, null=True, validators=[Funcionario.utilities.validateCEP])),
                ('estag_instituto_tel', models.CharField(blank=True, max_length=17, null=True, validators=[django.core.validators.RegexValidator(message="Entre Telefone no Formato: '(DDD)99999-9999'.", regex='^(\\+\\d{0,4})?(\\(\\d{0,3}\\))?([0-9\\-]{7,15})$')])),
            ],
        ),
        migrations.AddField(
