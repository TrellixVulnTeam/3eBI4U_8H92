# Generated by Django 2.1.7 on 2019-03-28 21:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docscan_certidao_nascimento', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_CERTIDAONASCIMENTO)),
                ('docscan_CPF', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_CPF)),
                ('docscan_vacinacao', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_VACINACAO)),
                ('docscan_RG', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_RG)),
            ],
        ),
        migrations.CreateModel(
            name='AddressInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basicinfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='Funcionario.BasicInfo')),
                ('docscan_picture', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_PICTURE)),
                ('docscan_CPF', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_CPF)),
                ('docscan_TE', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_TE)),
                ('docscan_CTPS', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_CTPS)),
                ('docscan_reservista', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_RESERVISTA)),
                ('docscan_certidao_nascimento', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_CERTIDAONASCIMENTO)),
                ('docscan_certidao_casamento', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_CERTIDAOCASAMENTO)),
                ('docscan_comprovante_resid', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_COMPROVANTERESIDENCIA)),
                ('docscan_comprovante_escolar', models.ImageField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_COMPROVANTEESCOLAR)),
                ('docscan_CV', models.FileField(blank=True, null=True, upload_to=Funcionario.utilities.funcionario_media_path_CV)),
            ],
        ),
        migrations.CreateModel(
            name='DocumentsInfo',
